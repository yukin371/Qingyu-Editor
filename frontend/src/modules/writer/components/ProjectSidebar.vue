...
.sidebar-search :deep(input.search-input::placeholder) {
  color: var(--editor-text-ghost, #94a3b8) !important;
}
...
.chapter-item {
  ...
  &.is-active {
    ...
    .item-title {
      color: color-mix(in srgb, var(--editor-accent, #1d4ed8) 72%, white 28%);
      font-weight: 700;
    }
  }
