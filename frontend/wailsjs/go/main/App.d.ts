...
export function AgentStreamIntent(arg1:ai.Config,arg2:string,arg3:string,arg4:string,arg5:agent.EditorContext):Promise<string>;

export function ReviewChapterStream(arg1:ai.Config,arg2:string,arg3:string,arg4:string,arg5:string):Promise<string>;

export function ReviewFullProjectStream(arg1:ai.Config,arg2:string,arg3:string):Promise<string>;

export function CreateChapter(arg1:database.CreateChapterInput):Promise<database.Chapter>;

export function CreateAgentConversation(arg1:string):Promise<agent.Conversation>;

export function DeleteAgentConversation(arg1:string):Promise<void>;

export function GetAgentConversation(arg1:string):Promise<agent.Conversation>;

export function ListAgentConversations(arg1:string):Promise<Array<agent.Conversation>>;

export function SaveAgentMessage(arg1:string,arg2:agent.ConversationMessage):Promise<agent.ConversationMessage>;

export function UpdateAgentConversationTitle(arg1:string,arg2:string):Promise<void>;
...
export function ReviewChapter(arg1:ai.Config,arg2:string,arg3:string,arg4:string):Promise<agent.ReviewResult>;

export function ReviewFullProject(arg1:ai.Config,arg2:string):Promise<agent.ReviewResult>;
